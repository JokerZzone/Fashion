...
public class CollectionContorller {
	...
	@ResponseBody
	public void addCollection(HttpSession session,int goods_id) {
		User user = (User) session.getAttribute("user");
		int uId = user.getuId();
	...
	@ResponseBody
	public void deleteCollection(HttpSession session,int[] goodsIds) {
		User user = (User) session.getAttribute("user");
		int uId = user.getuId();
	...
	@ResponseBody
	public void deleteAllCollection(HttpSession session) {
		User user = (User) session.getAttribute("user");
		int uId = user.getuId();
